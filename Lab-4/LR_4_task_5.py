...
def Marchenko_find_TP(y_true, y_pred):
    # counts the number of true positives (y_true = 1, y_pred = 1)
    return sum((y_true == 1) & (y_pred == 1))

def Marchenko_find_FN(y_true, y_pred):
    # counts the number of false negatives (y_true = 1, y_pred = 0)
    return sum((y_true == 1) & (y_pred == 0)) # your code here

def Marchenko_find_FP(y_true, y_pred):
    # counts the number of false positives (y_true = 0, y_pred = 1)
    return sum((y_true == 0) & (y_pred == 1)) # your code here

def Marchenko_find_TN(y_true, y_pred):
    # counts the number of true negatives (y_true = 0, y_pred = 0) 
    return sum((y_true == 0) & (y_pred == 0)) # your code here

print('TP:',Marchenko_find_TP(df.actual_label.values, df.predicted_RF.values))
print('FN:',Marchenko_find_FN(df.actual_label.values, df.predicted_RF.values))
print('FP:',Marchenko_find_FP(df.actual_label.values, df.predicted_RF.values))
print('TN:',Marchenko_find_TN(df.actual_label.values, df.predicted_RF.values))

def find_conf_matrix_values(y_true,y_pred):
    # calculate TP, FN, FP, TN
    TP = Marchenko_find_TP(y_true,y_pred)
    FN = Marchenko_find_FN(y_true,y_pred)
    FP = Marchenko_find_FP(y_true,y_pred)
    TN = Marchenko_find_TN(y_true,y_pred)
    return TP,FN,FP,TN
...
def my_accuracy_score(y_true, y_pred):
    ...
    TP,FN,FP,TN = find_conf_matrix_values(y_true,y_pred)
    return (TP + TN) / (TP + TN + FP + FN) # your code here
...
def my_precision_score(y_true, y_pred):
    ...
    TP,FN,FP,TN = find_conf_matrix_values(y_true,y_pred)
    # Запобігання діленню на нуль, якщо немає жодного 'predicted positive' (TP+FP=0)
    if (TP + FP) == 0:
        return 0.0
...
def my_f1_score(y_true, y_pred):
    ...
    # Запобігання діленню на нуль, якщо precision + recall = 0
